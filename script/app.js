...
class Bd {
    ...
    recuperarTodosRegistros() {
        ...
        //recuperar todas as dispesasa cadastradas em storage
        let id = localStorage.getItem('id')
...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modalTituloDiv').className = 'modal-header text-succes'
        ...
        document.getElementById('modalConteudo').innerHTML = 'Despesa não cadastrada, preencha todos os campos'
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    despesas.forEach(function(d) {
        ...
        //inserir valoree nas colunas(td)
